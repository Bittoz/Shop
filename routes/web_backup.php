...
use App\Http\Controllers\Admin\AccountInventoryController;

/* Admin Panel Routes */
Route::prefix('admin')
    ->name('admin.')
    ->middleware(['is_admin', 'XSS', 'HtmlMinifier'])
    ->group(function () {

    Route::get('/', 'Admin\AdminController@admin')->middleware('cacheable:5');
	...
	/* Non-downloadable products (New Addition) */
    Route::get('account-inventories', [AccountInventoryController::class, 'index'])->name('account_inventory.index');
    Route::get('account-inventories/create', [AccountInventoryController::class, 'create'])->name('account_inventory.create');
    Route::post('account-inventories', [AccountInventoryController::class, 'store'])->name('account_inventory.store');
    Route::delete('account-inventories/{accountInventory}', [AccountInventoryController::class, 'destroy'])->name('account_inventory.destroy');
});
...
Route::get('/checkout-stripe/{ord_token}', 'ProductController@stripe_success');
/* success */
