...
/* admin panel */
    ...
    /* ------------- Account-Inventory (non-downloadable products) ------------- */

/* list / search */
Route::get('/admin/account-inventories',
    [AccountInventoryController::class, 'index']
)->name('admin.account-inventories');

/* show create form */
Route::get('/admin/account-inventories/create',
    [AccountInventoryController::class, 'create']
)->name('admin.account-inventories.create');

/* store new batch or single credential */
Route::post('/admin/account-inventories',
    [AccountInventoryController::class, 'store']
)->name('admin.account-inventories.store');

/* delete / revoke one credential */
Route::delete('/admin/account-inventories/{id}',
    [AccountInventoryController::class, 'destroy']
)->name('admin.account-inventories.destroy');
