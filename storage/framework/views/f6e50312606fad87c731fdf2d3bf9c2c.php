...
<html lang="en">
<head>
<title><?php echo e(__('Free Items')); ?> - <?php echo e($allsettings->site_title); ?></title>
...
<div <?php if($custom_settings->theme_layout == 'container'): ?> class="container-fluid py-5 mt-md-2 mb-2 flash-sale" <?php else: ?> class="container py-5 mt-md-2 mb-2 flash-sale" <?php endif; ?>>
      ...
      <div class="row pt-2 mx-n2">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $free['product']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
...
</html><?php /**PATH /home/arixmyii/bittoz.shop/public_html/resources/views/pages/free-items.blade.php ENDPATH**/ ?>