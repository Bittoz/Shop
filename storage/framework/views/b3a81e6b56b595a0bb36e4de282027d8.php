        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(__('New Releases')); ?></li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white"><?php echo e(__('New Releases')); ?></h1>
        </div>
      </div>
      </div>
    </section>
<div <?php if($custom_settings->theme_layout == 'container'): ?> class="container-fluid py-5 mt-md-2 mb-2" <?php else: ?> class="container py-5 mt-md-2 mb-2" <?php endif; ?>>
      <?php if(in_array('new-releases',$top_ads)): ?>
      <div class="row">
      ...
      <div class="row pt-2 mx-n2">
       ...
       <?php if(in_array('new-releases',$bottom_ads)): ?>
       <div class="row">
          <div class="col-lg-12 mb-4" align="center">
...
</html><?php /**PATH /home/arixmyii/bittoz.shop/public_html/resources/views/pages/new-releases.blade.php ENDPATH**/ ?>