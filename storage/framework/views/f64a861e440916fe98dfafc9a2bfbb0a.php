...
<?php if($view_name == 'admin-add-voucher-code'): ?>
...
<?php if($view_name == 'admin-general-settings' || $view_name == 'admin-add-coupon' || $view_name == 'admin-edit-coupon'): ?>
...
<?php endif; ?>
<script src="<?php echo e(URL::to('resources/views/admin/template/dropzone/min/dropzone.min.js')); ?>" type="text/javascript"></script><?php /**PATH /home/arixmyii/bittoz.shop/public_html/resources/views/admin/javascript.blade.php ENDPATH**/ ?>