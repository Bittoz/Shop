...
<html lang="en">
<head>
<title><?php echo e(__('Popular Items')); ?> - <?php echo e($allsettings->site_title); ?></title>
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(__('Popular Items')); ?></li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white"><?php echo e(__('Popular Items')); ?></h1>
        </div>
      </div>
      </div>
    </section>
...
</html><?php /**PATH /home/arixmyii/bittoz.shop/public_html/resources/views/pages/popular-items.blade.php ENDPATH**/ ?>