...
<html lang="en">
<head>
<title><?php if($allsettings->site_blog_display == 1): ?> <?php echo e($edit['post']->post_title); ?> <?php else: ?> <?php echo e(__('404 Not Found')); ?> <?php endif; ?> - <?php echo e($allsettings->site_title); ?></title>
...
<section class="bg-position-center-top" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_other_banner); ?>');">
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(__('Blog')); ?></li>
            </ol>
          </nav>
        </div>
    ...
    <div <?php if($custom_settings->theme_layout == 'container'): ?> class="container-fluid pb-5" <?php else: ?> class="container pb-5" <?php endif; ?>>
      <div class="row pt-5 mt-md-2">
        <section <?php if($custom_settings->theme_layout == 'container'): ?> class="col-lg-9" <?php else: ?> class="col-lg-8" <?php endif; ?>>
          <?php if(in_array('post-details',$top_ads)): ?>
          ...
          <?php if(Auth::check()): ?>
          <div class="pt-2 mt-5" id="comments">
            <h2 class="h4"><?php echo e(__('Comments')); ?><span class="badge badge-secondary font-size-sm text-body align-middle ml-2"><?php echo e($count); ?></span></h2>
            <!-- comment-->
            <?php if($count != 0): ?>
            <?php $no = 1; ?>
              ...
              <div class="card-body">
                ...
                <form class="media-body needs-validation ml-3" action="<?php echo e(route('single')); ?>" method="post" novalidate>
                    ...
                    <div class="form-group">
                      <textarea class="form-control" rows="4" placeholder="<?php echo e(__('Write comment')); ?>..." name="comment_content" required></textarea>
          ...
          <?php endif; ?>
          <?php if(in_array('post-details',$bottom_ads)): ?>
          ...
          <div class="cz-sidebar border-left ml-lg-auto" id="blog-sidebar">
            ...
            <div class="cz-sidebar-body py-lg-1" data-simplebar data-simplebar-auto-hide="true">
              ...
              <div class="widget mb-grid-gutter">
                <h3 class="widget-title"><?php echo e(__('Post tags')); ?></h3>
              ...
              <?php if(in_array('post-details',$sidebar_ads)): ?>
...
</html><?php /**PATH /home/arixmyii/bittoz.shop/public_html/resources/views/pages/single.blade.php ENDPATH**/ ?>