...
<html lang="en">
<head>
<title><?php echo e(__('Subscriber Downloads')); ?> - <?php echo e($allsettings->site_title); ?></title>
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(__('Subscriber Downloads')); ?></li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white"><?php echo e(__('Subscriber Downloads')); ?></h1>
        </div>
      </div>
      </div>
    </section>
<div <?php if($custom_settings->theme_layout == 'container'): ?> class="container-fluid py-5 mt-md-2 mb-2" <?php else: ?> class="container py-5 mt-md-2 mb-2" <?php endif; ?>>
      <?php if(in_array('popular-items',$top_ads)): ?>
      <div class="row">
      ...
      <div class="row pt-2 mx-n2">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $subscriber_downloads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
       ...
       <?php if(in_array('popular-items',$bottom_ads)): ?>
       <div class="row">
...
</html><?php /**PATH /home/arixmyii/bittoz.shop/public_html/resources/views/pages/subscriber-downloads.blade.php ENDPATH**/ ?>